...
%   previous inset plot style as requested.
    ...
    xlim(ax1_left, [0, 1]); ylim(ax1_left, [0, 3]); set_publication_style(ax1_left); hold(ax1_left, 'off');
    ...
    xlim(ax1_right, [0, 1]); legend(ax1_right, 'show'); set_publication_style(ax1_right); hold(ax1_right, 'off');
    ...
    xlim(ax2_left, [0, 1]); legend(ax2_left, 'show'); set_publication_style(ax2_left); hold(ax2_left, 'off');
    ...
    xlim(ax2_right, [0, 1]); ylim(ax2_right, [0, 10]); legend(ax2_right, 'show'); set_publication_style(ax2_right); hold(ax2_right, 'off');

...
%   Creates two figures, each opening as a tab in a docked window.
    ...
    xlim(ax1_left, [0, 1]); ylim(ax1_left, [0, 3]); legend(ax1_left, 'show', 'Location', 'southeast');
    ...
    xlim(ax1_right, [0, 1]); legend(ax1_right, 'show', 'Location', 'southwest'); set_publication_style(ax1_right); hold(ax1_right, 'off');
    ...
    xlim(ax2_left, [0, 1]); legend(ax2_left, 'show', 'Location', 'northwest'); set_publication_style(ax2_left); hold(ax2_left, 'off');
    ...
    xlim(ax2_right, [0, 1]); ylim(ax2_right, [0, 10]); legend(ax2_right, 'show', 'Location', 'northwest'); set_publication_style(ax2_right); hold(ax2_right, 'off');

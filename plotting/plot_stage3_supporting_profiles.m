...
%      Collision Time, (c) Electron Collision Frequency, and (d) Ion Collision Frequency.
    ...
    yyaxis(ax1a, 'left');
    plot(ax1a, r_norm, derived_profiles.thermal_velocities.v_th_e, '-', 'LineWidth', 3, 'Color', colors(1,:));
    ylabel(ax1a, 'Electron Thermal Velocity, $v_{th,e}$ (m/s)'); ax1a.YColor = colors(1,:); ylim(ax1a, [0, 2e7]);
    yyaxis(ax1a, 'right');
    plot(ax1a, r_norm, derived_profiles.thermal_velocities.v_th_i, '-', 'LineWidth', 3, 'Color', colors(2,:));
    ...
    plot(ax1b, r_norm, derived_profiles.collisions.ln_lambda_ee, 'LineWidth', 3, 'DisplayName', '$\lambda_{ee}$');
    plot(ax1b, r_norm, derived_profiles.collisions.ln_lambda_ei, 'LineWidth', 3, 'DisplayName', '$\lambda_{ei}$');
    plot(ax1b, r_norm, derived_profiles.collisions.ln_lambda_ii, 'LineWidth', 3, 'DisplayName', '$\lambda_{ii}$');
    ...
    plot(ax1c, r_norm, derived_profiles.q_and_shear.q_profile, '-', 'LineWidth', 3, 'DisplayName', 'Safety Factor $q$');
    plot(ax1c, r_norm, derived_profiles.q_and_shear.s_profile, '--', 'LineWidth', 3, 'DisplayName', 'Magnetic Shear $s$');
    ...
    plot(ax1d, r_norm, derived_profiles.collisionality.nu_star_i, '-', 'LineWidth', 3, 'DisplayName', 'Ion Collisionality ($\nu_{*i}$)');
    plot(ax1d, r_norm, derived_profiles.collisionality.nu_star_e, '--', 'LineWidth', 3, 'DisplayName', 'Electron Collisionality ($\nu_{*e}$)');
    ...
    plot(ax2a, r_norm, derived_profiles.collisions.tau_e_calc, '--', 'LineWidth', 3.5, 'DisplayName', '$\tau_e (\lambda_{ei,calc})$');
    plot(ax2a, r_norm, derived_profiles.collisions.tau_e_15, '-', 'LineWidth', 4.5, 'DisplayName', '$\tau_e (\lambda = 15)$');
    plot(ax2a, r_norm, derived_profiles.collisions.tau_e_17, '-.', 'LineWidth', 3.5, 'DisplayName', '$\tau_e (\lambda = 17)$');
    ...
    plot(ax2b, r_norm, derived_profiles.collisions.tau_i_calc, '--', 'LineWidth', 3.5, 'DisplayName', '$\tau_i (\lambda_{ii,calc})$');
    plot(ax2b, r_norm, derived_profiles.collisions.tau_i_15, '-', 'LineWidth', 4.5, 'DisplayName', '$\tau_i (\lambda = 15)$');
    plot(ax2b, r_norm, derived_profiles.collisions.tau_i_17, '-.', 'LineWidth', 3.5, 'DisplayName', '$\tau_i (\lambda = 17)$');
    ...
    plot(ax2c, r_norm, derived_profiles.collisions.nu_ei_15 / 1e5, '-', 'LineWidth', 3.5, 'DisplayName', '$\nu_{e} (\lambda = 15)$');
    plot(ax2c, r_norm, derived_profiles.collisions.nu_ei_calc / 1e5, '--', 'LineWidth', 3, 'DisplayName', '$\nu_{e} (\lambda_{ei,calc})$');
    ...
    plot(ax2d, r_norm, derived_profiles.collisions.nu_i_15 / 1e3, '-', 'LineWidth', 3.5, 'DisplayName', '$\nu_{i} (\lambda = 15)$');
    plot(ax2d, r_norm, derived_profiles.collisions.nu_i_calc / 1e3, '--', 'LineWidth', 3, 'DisplayName', '$\nu_{i} (\lambda_{ii,calc})$');

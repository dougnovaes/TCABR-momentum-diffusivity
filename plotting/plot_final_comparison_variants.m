...
%   their own Monte Carlo-derived 95% CIs.
    ...
    h_th_fill1 = fill(ax, [r_norm; flipud(r_norm)], [var_data.ci_lower; flipud(var_data.ci_upper)], ...
        colors(2,:), 'FaceAlpha', 0.15, 'EdgeColor', 'none', 'DisplayName', '95% CI (Theory)');
    h_th_mean1 = plot(ax, r_norm, var_data.profile_avg, '--', 'LineWidth', 2.5, 'Color', colors(2,:), ...
    ...
    h_th_fill2 = fill(ax, [r_norm; flipud(r_norm)], [var_data_2.ci_lower; flipud(var_data_2.ci_upper)], ...
        colors(3,:), 'FaceAlpha', 0.15, 'EdgeColor', 'none', 'HandleVisibility', 'off');
    h_th_mean2 = plot(ax, r_norm, var_data_2.profile_avg, '-.', 'LineWidth', 2.5, 'Color', colors(3,:), ...
